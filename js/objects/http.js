...
req.open("GET", "http://cbs-staging.phunware.com/sample-xml/js/objects/test.json", false);
req.send();
...
// NOTE: Normally you will set the 3rd parameter to true, which will make the http request asyncrhonous.
reqXML.open("GET", "http://cbs-staging.phunware.com/sample-xml/js/objects/test.xml", false);
reqXML.send();
